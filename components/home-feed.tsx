    ...
    <div className="space-y-10">
      <section className="rounded-[32px] border border-border bg-surface p-5 md:p-7">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">
          A página inicial mostra as viagens mais recentes das pessoas que você acompanha e atualiza conforme você segue
          ou deixa de seguir alguém.
        </p>
        <div className="mt-6">
          <SearchBar
      ...
      <section className="space-y-5">
        ...
        {followedTrips.length > 0 ? (
          ...
          <div className="rounded-[24px] border border-dashed border-border bg-surface p-6 text-sm text-muted">
            Você ainda não segue ninguém. Vá em <Link href="/pessoas" className="text-text underline">Pessoas</Link> e
